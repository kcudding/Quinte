...
#     bfac.ri= fac.ri
  ...
  regout=summary(fm.ri)$coefficients 

regco=kable((regout), digits=2,format="html", table.attr = "style='width:60%;'",
   caption=paste(mmetric,"Site", stvec[i]))
tsave=footnote(kable_classic(regco),
         general = paste("adj. R squared=", round((summary(fm.ri)$adj.r.squared),2)),
